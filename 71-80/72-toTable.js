...
// Function
const toTable = (arr, headers=false, index=false) => {
    ...
    for (let i=0; i<arr.length; i++) {
      ...
      if (i >= offset) {
        ...
        if (index) {
          outputString += "<td>";
          outputString += (i + 1 - offset).toString();
          outputString += "</td>";
        }
...
// Log test
let tableArray = [['First Name','Last Name'],['John',null], ['Cheryl','Dahle'], ['Tim', false], [7.7,666]]
console.log ( toTable(tableArray, false,true));
